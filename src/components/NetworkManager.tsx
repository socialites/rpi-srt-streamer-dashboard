                        ...
                        <div class='w-full h-auto relative'>
                            ...
                            {network.in_use && (
                                <div class="absolute top-0 right-0 p-2">
                                    <Button className="bg-red-500 w-4 h-4 text-white text-xs !p-2 flex items-center justify-center rounded-md" onClick={() => promptForgetNetwork(network.ssid)}>🗑️</Button>
                                </div>
                            )}
                        </div>
                    ))}
